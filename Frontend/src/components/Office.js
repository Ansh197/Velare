  ...
  const [productData,setProductData] = useState([]);
    ...
    function addToCart(index){
      ...
      const effectFunction = async() =>{
        var productObject = {colorFilter:colorFilter,brandFilter:brandFilter,categoryFilter:["Office"]};
        await axios.post('http://localhost:5000/pages/office',productObject)
          .then(res=>{
